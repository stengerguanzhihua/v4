          ...
          <div class="navbar-collapse">
            ...
            <ul class="nav navbar-nav quick-actions">
              ...
              <li class="dropdown divided">
                ...
                <ul class="dropdown-menu wide arrow nopadding bordered">
                  <li><h5>你有<strong>2</strong>个需要处理的事务</h5></li>
                  <li>
                    <a href="#">
                      <div class="task-info">
            ...
            <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <li class="navigation" id="navigation">
                <a href="#" class="sidebar-toggle" data-toggle="#navigation">我的控制台<i class="fa fa-angle-up"></i></a>
                ...
                <ul class="menu">
                  ...
                  <li class="dropdown active">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-truck"></i> 购买商品 <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
                        <a href="buy.php">
                          <i class="fa fa-caret-right"></i>我要购买
                        </a>
                      </li>
                      <li>
                        <a href="stock.html">
                          <i class="fa fa-caret-right"></i> 我的库存
                        </a>
                      </li>
                      <li>
                        <a href="purchasehistory.html">
                          <i class="fa fa-caret-right"></i>我的消费记录
                        </a>
                      </li>
                    </ul>
                  </li>
				  ...
				  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-money"></i> 财务管理 <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
                        <a href="form-elements.html">
                          <i class="fa fa-caret-right"></i>账目明细
                        </a>
                      </li>
                      <li>
                        <a href="form-wizard.html">
                          <i class="fa fa-caret-right"></i>下级财务
                        </a>
                      </li>
                    </ul>
                  </li>
				 ...
				 <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-envelope-o"></i> 信息管理 <b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
                        <a href="form-elements.html">
                          <i class="fa fa-caret-right"></i>我的资料
                        </a>
                      </li>
                      <li>
                        <a href="form-wizard.html">
                          <i class="fa fa-caret-right"></i>个性设置
                        </a>
                      </li>
					  <li>
                        <a href="form-wizard.html">
                          <i class="fa fa-caret-right"></i>安全管理
                        </a>
                      </li>
                    </ul>
                  </li>
				  ...
				  <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <i class="fa fa-users"></i>人员管理<b class="fa fa-plus dropdown-plus"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
                        <a href="form-elements.html">
                          <i class="fa fa-caret-right"></i>员工管理
                        </a>
                      </li>
                      <li>
                        <a href="form-wizard.html">
                          <i class="fa fa-caret-right"></i>下线管理
                        </a>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li >
                    <a href="index.php">
                      <i class="fa fa-tachometer"></i> 我的数据
